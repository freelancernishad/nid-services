...
<div class="container">
    <div class="card">
        <div class="card-body">
            ...
            <p>চতুর্থ ধাপঃ এই ধাপে আপনি আপনার উল্লেখকৃত মোবাইল নং (যা আপনি Payment Wallet Number এ পূরণ করেছেন) হতে Send Money (রিচার্জকৃত টাকা) অপশন হতে আপনার নিকটস্থ এজেন্টকে প্রদান করে Trx/Transaction no. সংরক্ষণ করুন এবং Trx/Transaction Id ঘরে এটি সঠিকভাবে প্রদান করুন।</p>
